...
export function InventoryFilterForm({
  ...
  searchParams: { minPrice?: string; maxPrice?: string; type?: string; minSleeps?: string };
}) {
  return (
    <form
      method="get"
      className="grid gap-4 sm:grid-cols-4 rounded-lg border-2 border-charcoal/10 bg-white p-4 mb-8"
    >
